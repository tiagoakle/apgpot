...
semilogy(abs(res.err(:,3)),'r');
legend('Primal','Dual');
saveas(h,'../../Writeup/Images/hsd_llm_primal_dual_infeas_lpnetlib.png');
hold off
...
legend('\tau \kappa');
hold off
saveas(h,'../../Writeup/Images/hsd_llm_tau_over_kappa_lpnetlib.png');
...
legend('Centrality');
hold off
saveas(h,'../../Writeup/Images/hsd_llm_centrality_lpnetlib.png');
